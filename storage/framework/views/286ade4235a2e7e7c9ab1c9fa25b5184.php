        ...
        <div class="container">
            <div class="row gy-4">
                ...
                <div class="col-lg-5 col-md-12 footer-info">
                    <a href="<?php echo e(route('home')); ?>" class="logo d-flex align-items-center mb-3">
                        <img src="<?php echo e(asset('images/logoputih.png')); ?>" alt="Kang Naryo Logo" style="height: 40px; margin-right: 10px;">
                ...
                <div class="col-lg-2 col-6 footer-links">
                    ...
                    <ul>
                        <li><i class="fa-solid fa-chevron-right"></i> <a href="<?php echo e(route('home')); ?>">Home</a></li>
                        <li><i class="fa-solid fa-chevron-right"></i> <a href="<?php echo e(route('menu.page')); ?>">Menu</a></li>
                        <li><i class="fa-solid fa-chevron-right"></i> <a href="<?php echo e(route('gallery.page')); ?>">Galeri</a></li>
                    </ul>
                </div>
...
<?php /**PATH C:\xampp\htdocs\MPTI-Tugas Akhir1\resources\views/layouts/app.blade.php ENDPATH**/ ?>